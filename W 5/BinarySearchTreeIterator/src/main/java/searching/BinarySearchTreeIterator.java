...
public class BinarySearchTreeIterator<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    private class BSTIterator implements Iterator<Key> {
        ...
        public Key next() {
            ...
            // Don't forget the ConcurrentModificationError and the NoSuchElementException !
            // Et le cas de base de l'itérateur ! if(root == null) throw new NoSuchElementException();
